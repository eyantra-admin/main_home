...
Route::get('/eysip_register', [Home\HomeController::class, 'school_present'])->name('school_present');
...
Route::get('/events',[Home\HomeController::class, 'events'])->name('events.index');
